<template>
  <h3> {{ name }} </h3>
  <div v-for="(value, prop) in ability" :key="value">
    {{ prop }} : {{ value }}
  </div>
  <br>
  ...
  <div v-if="name">
    ...
    <el-row class="center-horz" :gutter="5">
      ...
      <el-col :span="5"> <span v-if="Object.keys(ability.bonuses).length"> Type </span> </el-col>
      ...
      <el-col :span="5">
        <el-button size="small" type="primary" @click="addBonus()" style="margin-bottom:5px;">addBonus</el-button>
      </el-col>
    </el-row>
