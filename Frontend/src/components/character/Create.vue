            ...
            <el-col :span="8">
              <el-tooltip placement="right" effect="light">
                ...
                <template #content>
                  ...
                  <span v-else> Choose within reason (or pick a gender to get ranges) </span>
                </template>
              </el-tooltip>
            </el-col>
          </el-row>
              ...
              <el-row :gutter="10">
                ...
                <el-col :span="9" class="center-vert">
                  ...
                  <span v-if="name == 'Linguistics'">
                    <el-select v-if="character.basics.race" v-model="character.skills.Linguistics.extras.languages" multiple filterable allow-create default-first-option :reserve-keyword="false">
    ...
    return {
      ...
      character: {
        ...
        basics : {
          ...
          "appearance": { "age": 21, "gender": "", "height": "", "weight": "" },
          "diety": "",
          "environment": "Urban",
          "favoredClass": { "name": "", "bonus": "" }
        },
        notes : "",
        userSettings : {
          "cardTab": "main",
